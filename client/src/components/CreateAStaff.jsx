...
const CreateAStaff = () => {
    ...
    const addInputForRoom = () => {
        ...
        newInput.className = 'px-2 py-1 border-2 border-black rounded-md w-20 h-12';
        newInput.type = 'number';
        rooms.current.appendChild(newInput);
    }
    return (
        <div className='flex flex-col mt-4 pt-1 pb-4 sm:px-12 sm:py-4 space-y-4 text-lg sm:text-2xl to-red-500'>
            ...
            <div className='input flex flex-col space-y-2'>
                ...
                <div ref={rooms} className="rooms flex space-x-1 flex-wrap">
                    <input type="number" className='px-2 py-1 border-2 border-black rounded-md w-20 h-12' />
                </div>
            </div>
